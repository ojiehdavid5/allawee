...
const Info = () => {
  ...
  return (
    <div className='mt-[20rem] min-h-screen flex justify-center items-center w-full mb-[10rem]   data-aos="fade-right"  max-lg:block max-lg:mt-[30rem] max-lg:space-y-8  '>
        <div className=' bg-white w-[25rem] h-[40rem] mr-4 rounded-3max-lg flex flex-col justify-between items-center  max-lg:h-[45rem] '>
            <button className='bg-[#DBFAC8] p-2 w-[10rem] rounded-md mt-5 -ml-[12rem] -mb-[5rem]'>
               <a className='text-1max-lg mt-3 '>For individual</a> 
            </button>
            <h1 className="text-4max-lg font-medium w-[20rem]  tex" >Spend like a Local.
...
<img src={img1} alt=''/>
        ...
        <button className='bg-[#ADECCF] p-3 rounded-md mt-5 -ml-[12rem] -mb-[5rem]'>
               <a className='text-1max-lg'>For business</a> 
            </button>
            <h1 className='text-4max-lg font-medium leading-10 w-[22rem] container h-[10rem] '>Card issuing & <br/>spend<br/>
...
alt=''/>
        ...
        <button className='bg-[#D6B9FB] p-3 rounded-md mt-5 -ml-[6rem] -mb-[1rem]'>
               <a className='text-1max-lg'>For developers building apps</a> 
            </button>
            <h1 className='text-4max-lg font-medium leading-10 w-[22rem] container h-[10rem] '>
            Cards, Accounts &
