...
const Hero = () => {
  return (
    <div className='mt-[8rem] flex  justify-center items-center flex-col max-lg:w-full max-lg:mt-[12rem]' >
      <p className='text-2max-lg text-white leading-7 max-lg:text-center'>SPEND LIKE A LOCAL, LIVE LIKE A TOURIST.
