...
const Tourist = () => {
  return (
    <div className='flex flex-col mt-[9rem]'>
        <h1 className='text-[10rem]  text-white font-jersey-20 font-[400] tracking-[-1rem] z-[99]'>SPEND{' '} LIKE{' '} A{' '} <span className='text-[#DBFAC8]'>LOCAL</span></h1>
      <h1 className='text-[10rem] text-white tracking-[-1rem] ml-[8rem]  z-[99]'><span className='text-[#C6A0D2]'>LIVE LIKE A</span> TOURISTS</h1>
<img src={skate} 
