...
const Faq = () => {
  ...
  return (
    <div className='flex flex-col min-h-screen mt-[10rem] justify-center items-center'>
      <div className={active ? 'w-[80rem] h-[18rem] mx-10 rounded-md flex flex-row items-center justify-between bg-[#161B39] border border-[#48535C]' : 'w-[80rem] h-[12rem] mx-10 rounded-md flex flex-row items-center justify-between bg-[#161B39] border border-[#48535C]'}>
